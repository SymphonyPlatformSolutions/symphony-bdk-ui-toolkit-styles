...
<div class="tk-mx-5h">
  ...
  <div class="avatar-box">
    <div class="tk-avatar tk-avatar--xlarge">
      <img class="tk-avatar" alt="avatar" src=${avatar}>
    </div>
    <div class="tk-avatar tk-avatar--xlarge tk-ml-5h">
      <img class="tk-avatar" alt="avatar" src=${avatar1}>
    </div>
    <div class="tk-avatar tk-avatar--xlarge tk-ml-5h">
      <img class="tk-avatar" alt="avatar" src=${avatar2}>
    </div>
  </div>
...
<div class="tk-ml-5h">
  ...
  <div class="avatar-box">
    ...
    <div class="tk-avatar tk-avatar--xlarge tk-mr-5h">
      <img alt="avatar" class="tk-avatar" src=${avatar1}>
      <span class="tk-badge tk-badge--bottom tk-bg-color--ok" style="width:30%; height:30%; border-radius:50%;"></span>
    </div>
    <div class="tk-avatar tk-avatar--large tk-mr-5h">
      <img alt="avatar" class="tk-avatar" src=${avatar2}>
  ...
  <p>To have a specific shape for the avatar component you can create your own clip-plath using svg and include it on
    the avatar.</p>
  <h3>Badge with icon</h3>
  <div class="avatar-box">
    <div class="tk-avatar tk-avatar--xlarge tk-mr-5h">
      <svg class="jss414" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <img class="tk-avatar" alt="avatar" src=${avatar} style="clip-path:url(#avatar_badge);">
      <i class="tk-badge tk-badge--bottom tk-icon-busy tk-text-color--warning" style="font-size:27px"></i>
    </div>
    <div class="tk-avatar tk-avatar--xlarge tk-mr-5h">
      <img class="tk-avatar" alt="avatar" src=${avatar1} style="clip-path:url(#avatar_badge);">
      <i class="tk-badge tk-badge--bottom tk-icon-offline " style="font-size:27px"></i>
    </div>
    <div class="tk-avatar tk-avatar--xlarge tk-mr-5h">
      <img class="tk-avatar" alt="avatar" src=${avatar2} style="clip-path:url(#avatar_badge);">
