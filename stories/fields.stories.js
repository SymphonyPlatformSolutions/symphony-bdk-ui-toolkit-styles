...
<div class="tk-m-4">
  ...
  <div class="tk-select--custom-dropdown tk-mt-2" style="width:256px">
    <div class="tk-select--custom-dropdown-option">Option 1</div>
    <div class="tk-select--custom-dropdown-option">Option 2</div>
    <div class="tk-select--custom-dropdown-option">Option 3
      <i class="tk-select--custom-dropdown-option--selected"></i>
    </div>
    <div class="tk-select--custom-dropdown-option">Option 4</div>
    <div class="tk-select--custom-dropdown-option">Option 5</div>
    <div class="tk-select--custom-dropdown-option">Option 7</div>
    <div class="tk-select--custom-dropdown-option">Option 8</div>
    <div class="tk-select--custom-dropdown-option">Example of long list option with two lines</div>
  </div>
</div>
`}